...
<html lang="pt">
	<head>
		<title>Inserir Impressora</title>
    ...
    <!-- -----------------FIM Menu esquerdo---------------------------------------- -->
                <div class="col-7 col-sm-9 col-md-10 col-lg-10 col-xl-10">
                    ...
                    <h1 class="h1">Inserir Impressora</h1><hr>
                    <form action="listar_impressora.php" method="post">
                        <div class="row">
                        <div class="col-12">
                          
                          <div class="form-group">
                            <label>Identificação</label>
                            <input type="text" class="form-control" name="idimp" required placeholder="Número de inventário">
                          </div>
                          <div class="form-group">
                            <label >Marca</label>
                            <select class="form-control" name="marcaimp">
                              <?php 
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="dptoimp">
                              <?php 
