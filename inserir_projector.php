...
<html lang="pt">
    ...
    <!-- -----------------FIM Menu esquerdo---------------------------------------- -->
                <div class="col-7 col-sm-9 col-md-10 col-lg-10 col-xl-10">
                    ...
                    <h1 class="h1">Inserir Projector</h1><hr>
                    <form action="listar_projector.php" method="post">
                        <div class="row">
                        <div class="col-12">
                          
                          <div class="form-group">
                            <label>Identificação</label>
                            <input type="text" class="form-control" name="idpro" required placeholder="Número de inventário">
                          </div>
                          <div class="form-group">
                            <label >Marca</label>
                            <select class="form-control" name="marcapro">
                              <?php 
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="dptopro">
                              <?php 
                          ...
                          <div class="form-group">
                            <label >Estado</label>
                            <select class="form-control" name="estadopro">
